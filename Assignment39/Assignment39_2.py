...
def main():
   ...
   #Visualization
    ...
    #Confusion matrix generation
    print("Step 7 : Confusion matrix generation")
    matrix=confusion_matrix(y_test,y_pred)
    print(matrix)

    """
    Final Conclusion : 
    Here We used Supervised Machine Learning algorithm Decision tree Classifer
    because Given data is labled data.
    our Given model is good fitted now.
